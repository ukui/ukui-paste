...
//        }
    ...
    QObject::connect(this->__classify6, &PushButton::clicked, [this](void) {
        this->__db.deleleAllPasteItem();
        this->reloadData(0);
    });
    ...
    hlayout->addStretch();
    hlayout->addWidget(this->__classify6);
